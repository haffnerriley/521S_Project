...
if(sys.argv[1] == "-h" or sys.argv[1] == "--help"):
    print("Usage: FOScrapingUtility.py <coco export path (relative)> <dataset name> <class names (space separated)>")
    sys.exit(0)
...
dataset_or_view = foz.load_zoo_dataset(sys.argv[2], classes = [classes.join(sys.argv[3:])], label_types=["detections", "segmentations"], splits="train")
